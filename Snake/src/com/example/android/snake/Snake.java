...
public class Snake extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
    	...
    	case R.id.left_arrow_button:
    		mSnakeView.setNextDirection(mSnakeView.getDirection()%4+1);
    		break;
    	case R.id.right_arrow_button:
    		mSnakeView.setNextDirection(mSnakeView.getDirection()-1 == 0 ? 4 : mSnakeView.getDirection()-1);
    		break;
    	case R.id.slow_button:
    		mSnakeView.setMoveDelay(SnakeView.SLOW);
    		break;
    	case R.id.medium_button:
    		mSnakeView.setMoveDelay(SnakeView.MEDIUM);
    		break;
    	case R.id.fast_button:
    		mSnakeView.setMoveDelay(SnakeView.FAST);
    		break;
    	case R.id.resume_button:
    		break;
    	case R.id.settings_button:
    		Log.d(ICICLE_KEY,"hello");
    		break;
    	default:
    		return false;
    	}
    ...
    class MyGestureListener extends GestureDetector.SimpleOnGestureListener {
    	private static final String GESTURE_DEBUG = "Gestures";
    	...
    	public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
    			float velocityY) {
    		Log.d(GESTURE_DEBUG, "X: "+velocityX+"   Y: "+velocityY);
    		if(Math.abs(velocityX) > Math.abs(velocityY)) {
    			mSnakeView.setNextDirection(velocityX > 0 ? SnakeView.EAST : SnakeView.WEST);
    		} else {
    			mSnakeView.setNextDirection(velocityY > 0 ? SnakeView.SOUTH : SnakeView.NORTH);
    		}
    		return true;
    	}
    }
